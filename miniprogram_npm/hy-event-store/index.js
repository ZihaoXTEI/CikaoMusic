...
__DEFINE__(1667723443428, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1667723443429,"./event-store":1667723443430}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667723443429, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1667723443430, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1667723443429,"./utils":1667723443431}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667723443431, function(require, module, exports) {
...
return __REQUIRE__(1667723443428);
})()
